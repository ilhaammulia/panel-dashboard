<template>
    <div class="layout-topbar">
        ...
        <button class="p-link layout-topbar-menu-button layout-topbar-button" @click="onTopbarMenuToggle"
                :class="{ selector: '@next', enterClass: 'hidden', enterActiveClass: 'scalein',
			leaveToClass: 'hidden', leaveActiveClass: 'fadeout', hideOnOutsideClick: true}">
            <i class="pi pi-ellipsis-v"></i>
        </button>
        
        <ul class="layout-topbar-menu lg:flex origin-top" :class="{'hidden': mobileTopbar}">
            <li>
