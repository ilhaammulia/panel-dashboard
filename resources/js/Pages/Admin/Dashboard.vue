      ...
      <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        <ul class="space-y-2">
          ...
          <li>
            ...
            >
            <svg 
              class="flex-shrink-0 ml-1 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" 
          ...
          <li>
            ...
            >
            <svg
              class="flex-shrink-0 w-5 ml-1 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" 
              aria-hidden="true" xmlns="http://www.w3.org/2000/svg" 
              fill="currentColor" 
              viewBox="0 0 20 20">
              <path 
          ...
          <li class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
            <a
              ...
              class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group"
            >
              <svg class="flex-shrink-0 w-5 ml-1 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16">
...
export default {
  components: { Cards, Graph, RecentUser },
  methods: {
    to(link) {
